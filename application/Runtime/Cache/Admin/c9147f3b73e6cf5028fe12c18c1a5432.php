	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($role_list)): foreach($role_list as $key=>$vo): ?><tr>
            	<td class="num"><?php echo ($vo["role_id"]); ?></td>
                <td class="name"><?php echo ($vo["role_name"]); ?></td>
                <td class="process"><?php echo ($vo["role_ids"]); ?></td>
                <td class="node"><?php echo ($vo["role_path"]); ?></td>
                <td class="operate">
                	<a href="<?php echo U('Zcxdistribute', 'id='.$vo[role_id]);?>">分配权限</a>
                </td>
